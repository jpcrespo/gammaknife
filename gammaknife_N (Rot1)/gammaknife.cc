...
int main(int argc ,char ** argv)
{
  ...
  G4ScoringManager::GetScoringManager(); // This enables scoring //Habilita el scoring mesh 
  ...
  GammaKnifeController* controller = new GammaKnifeController( detector ); //En gammaknife controller rota el scoring mesh 
  controller->ReadFile("MachineAngle.in"); // pre-load default // Cargan los diferentes angulos  
